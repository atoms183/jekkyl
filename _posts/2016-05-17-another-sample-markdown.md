...
Мы создадим простой, но реалистичный модуль комментариев для блога, упрощенный аналог модуля комментариев реального времени, предлагаемый такими ресурсами как Disqus, LiveFyre и Facebook.</p><br/>
<p>Мы обеспечим:</p><br/>
<ul>
...
<p>Также будут реализованы:</p><br/>
<ul>
